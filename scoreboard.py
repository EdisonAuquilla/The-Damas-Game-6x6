...
class Scoreboard(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.label_blanco = tk.Label(self.frame_blanco, text=self.nombre_jugador_blanco, font=("Arial", 16, "bold"), bg='#f0f0f0', fg='black')
        self.label_blanco.pack()

        self.label_fichas_eliminadas_blanco = tk.Label(self.frame_blanco, text="Fichas eliminadas: 0", font=("Arial", 14), bg='#f0f0f0', fg='black')
        self.label_fichas_eliminadas_blanco.pack()

        self.label_partidas_ganadas_blanco = tk.Label(self.frame_blanco, text="Partidas ganadas: 0", font=("Arial", 14), bg='#f0f0f0', fg='black')
    ...
    def actualizar(self):
        ...
        fichas_eliminadas_negro = stats_negro[2]
        partidas_ganadas_negro = stats_negro[1]
        
        fichas_eliminadas_blanco = stats_blanco[2]
        partidas_ganadas_blanco = stats_blanco[1]
